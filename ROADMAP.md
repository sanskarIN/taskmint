...
- [x] Generate and commit the npm lockfile from a successful real registry resolution and add it to the tracked-file documentation inventory
- [x] Review and commit the genuine Cargo lockfile generated by native validation, then add it to the tracked-file documentation inventory
